...
- Know how to use the [Discover and Dashboards search bar]({{site.url}}{{site.baseurl}}/dashboards/discover/search-bar) and the [time filter]({{site.url}}{{site.baseurl}}/dashboards/discover/time-filter).

- Understand [OpenSearch documents and indexes]({{site.url}}{{site.baseurl}}/getting-started/intro/#document).
...
1. Select the {::nomarkdown}<img src="{{site.url}}{{site.baseurl}}/images/icons/clock-icon.png" class="inline-icon" alt="time-select icon"/>{:/} (clock) icon to filter the time range of your search.
...
1. From a row in the data table's left column, select the {::nomarkdown}<img src="{{site.url}}{{site.baseurl}}/images/icons/arrow-right-icon.png" class="inline-icon" alt="expand icon"/>{:/} icon to open the **Document Details** window.
...
1. Select the {::nomarkdown}<img src="{{site.url}}{{site.baseurl}}/images/icons/arrow-down-icon.png" class="inline-icon" alt="collapse icon"/>{:/} icon to close the **Document Details** window.
...
For more information, see [Discover and Dashboard search bar]({{site.url}}{{site.baseurl}}/dashboards/discover/search-bar).
