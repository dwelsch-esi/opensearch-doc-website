...
1. From an OpenSearch Dashboards application (**Discover**, **Dashboards**, or **Visualize**), select the {::nomarkdown}<img src="{{site.url}}{{site.baseurl}}/images/icons/clock-icon.png" class="inline-icon" alt="clock icon"/>{:/} icon on the right of the search bar.
...
1. Choose a start time:
   ...
   1. Using the selected framing, choose a start date-time.
...
1. Choose **Update** to apply changes, as shown in the following image.
   ...
   The data table or visualization displayed in the application automatically updates to reflect the new time interval fiter.